...
OBJECT objs[] = {
	{	/* 0 = field */
		...
		NULL,
		NULL,
		 "The field is a nice and quiet place under the blue sky",
		"You see",
	...
	{	/* 3 = gold */
		...
		NULL,
		NULL,
		 "The shiny coin seems to be a rare and pricesless artifact",
		"You see",
		"You can't get much closer than this.",
		 1,
		0,
	...
	{	/* 6 = intoCave */
		...
		"You see",
		 "The guard stops you from entering the cave.",
		99,
		0,
		0
	},
	{	/* 7 = exitCave */
		...
		tags7,
		 ...
		 field,
		 field,
		 "Sunlight pours in through an opening in the cave wall.",
		"You see",
